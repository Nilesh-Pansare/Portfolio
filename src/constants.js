...
export const SkillsInfo = [
  ...
  export const education = [
    ...
    // },
    {
      id: 2,
      img: vpsLogo,
      school: "Shri Mahavir Arts Commerce And Science College, Lasalgaon",
      date: "Apr 2018 - March 2019",
      grade: "65%",
      desc: "I completed my class 12 education from Shree Mahavir Arts Commerce And Science College, Lasalgaon, under the HSC board, where I studied Physics, Chemistry, and Mathematics (PCM) with Computer Science.",
      degree: "HSC(XII) - PCM with Computer Science",
    },
    {
      id: 3,
      img: vpsLogo,
      school: "Loknete Dattaji Patil Vidyalaya Lasalgaon In Nashik",
      date: "Apr 2015 - March 2016",
      grade: "70%",
      desc: "I completed my class 10 education from Loknete Dattaji Patil Vidyalaya, under the SSC board, where I studied Science",
